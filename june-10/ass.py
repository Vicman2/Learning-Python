...
# Using the softsign activation error, the MSE is high hence having a linear curve near 1
# This is because softsign is bounded above by 1

# The leaky_rulu activation function has a lower loss of lower loss compared to the softsign and greater loss 
# when compared to the softplus. 
#Also, the slope  from -2.5 to 2.5 is minimal and slightly negligible 
#Also, it is a combination of piecewise lines from -2.5 to 2.5

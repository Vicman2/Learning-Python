...
model.add(tf.keras.layers.RandomTranslation(height_factor=0.04, width_factor=0.04))
model.add(tf.keras.layers.Dropout(0.1))
model.add(tf.keras.layers.Conv2D(filters=64, kernel_size=(3,3), activation=R))
...
model.add(tf.keras.layers.Conv2D(filters=32, kernel_size=(3,3), activation=R))
model.add(tf.keras.layers.MaxPooling2D())
